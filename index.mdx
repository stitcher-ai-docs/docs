...
<Card title="How to: Set up my authoring environment" icon="wrench" href="/how-to/set-up-authoring-environment">
  Install the StitcherAI extension, open your pipeline configuration repo, and log in.
</Card>
